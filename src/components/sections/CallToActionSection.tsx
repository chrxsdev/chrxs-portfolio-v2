        ...
        <div className='relative py-20 z-10'>
          ...
          <div className='grid md:grid-cols-3 gap-6 mb-10'>
            <div className='flex flex-col items-center p-6 bg-card/30 backdrop-blur-sm rounded-xl border border-border hover:bg-card/50 transition-all duration-300'>
              <MessageCircle className='w-8 h-8 text-minimal-green mb-3' />
            ...
            <div className='flex flex-col items-center p-6 bg-card/30 backdrop-blur-sm rounded-xl border border-border hover:bg-card/50 transition-all duration-300'>
              <Send className='w-8 h-8 text-minimal-lemon mb-3' />
            ...
            <div className='flex flex-col items-center p-6 bg-card/30 backdrop-blur-sm rounded-xl border border-border hover:bg-card/50 transition-all duration-300'>
              <Calendar className='w-8 h-8 text-minimal-lemon mb-3' />
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
            <Button
              size='lg'
              asChild
              className='bg-gradient-to-r from-minimal-green to-minimal-lemon hover:from-minimal-green/80 hover:to-minimal-lemon/80 text-white border-0 px-8 py-3 rounded-full'
            >
              <Link to='/contact'>
          ...
          <div className='flex justify-center gap-6 mt-8'>
            <Link
              ...
              className='text-muted-foreground hover:text-minimal-green transition-colors'
              target='_blank'
            >
            ...
            <Link
              ...
              className='text-muted-foreground hover:text-minimal-lemon transition-colors'
              target='_blank'
            >
